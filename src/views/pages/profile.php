                        ...
                        <div class="profile-info-data row">
                            <?php if($user->id != $loggedUser->id): ?>
                                <div class="profile-info-item m-width-20">
                                    <?php if($isFollowing): ?>
                                        <a class="button" href="">Deixar de Seguir</a>
                                    <?php else: ?>
                                        <a class="button" href="">Seguir</a>
                                    <?php endif; ?>
                                </div>
                            <?php endif; ?>
                            <div class="profile-info-item m-width-20">
                        ...
                        <?php for($q=0;$q<9;$q++): ?>
                            <?php if(isset($user->following[$q])): ?>
                                <div class="friend-icon">
                                    <a href="<?= $base; ?>/perfil/<?= $user->$follower[$q]->id; ?>">
                                        <div class="friend-icon-avatar">
                                            <img src="<?= $base; ?>/media/avatars/<?= $user->$follower[$q]->avatar; ?>" />
                                        </div>
                                        <div class="friend-icon-name">
                                            <?= $user->$follower[$q]->name; ?>
                                        </div>
                                    </a>
                                </div>
                            <?php endif; ?>
